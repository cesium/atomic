defmodule AtomicWeb.Components.Board do
  ...
  def member_bubble(assigns) do
    ...
    <div class="mx-auto mt-12 mb-12 w-full px-4 sm:w-6/12 md:w-1/3 lg:1/4 lg:mb-0 xl:w-2/12">
      <.avatar class="mx-auto" bg_color="zinc-400" fg_color="white" name={@user_organization.user.name} size={:xl} src={Uploaders.ProfilePicture.url({@user_organization.user.profile_picture, @user_organization.user}, :original)} />
