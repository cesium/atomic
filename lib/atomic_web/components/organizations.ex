      ...
      <%= for organization <- @organizations do %>
        <li>
          <div
            ...
            type="button"
          >
            <span class="text-[0.625rem] flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-zinc-200 font-medium text-zinc-400 group-hover:border-orange-600 group-hover:text-orange-600">
