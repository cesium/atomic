defmodule AtomicWeb.Components.Button do
  ...
  def primary_button(assigns) do
    ~H"""
    <.link patch={@url} class="bg-primary inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-600 focus-visible:outline-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">
