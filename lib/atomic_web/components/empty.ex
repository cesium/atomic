defmodule AtomicWeb.Components.Empty do
  ...
  def empty_state(assigns) do
    ...
    <div id={@id} class="text-center">
      ...
      <div class="mt-6">
        <.link navigate={@url} class="inline-flex items-center rounded-md bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">
