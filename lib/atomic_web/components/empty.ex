defmodule AtomicWeb.Components.Empty do
  ...
  def empty_state(assigns) do
    ...
    <div id={@id} class="text-center">
      ...
      <div class="mt-4">
        <.link navigate={@url} class="bg-primary inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-600 focus-visible:outline-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">
