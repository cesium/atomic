defmodule AtomicWeb.OrganizationLive.Components.OrganizationBannerPlaceholder do
  @moduledoc false
  use AtomicWeb, :component

  def organization_banner_placeholder(assigns) do
    {gradient_color_a, gradient_color_b} = generate_color(assigns.organization.id)
  ...
  defp generate_color(uuid) when is_binary(uuid) do
    # List of gradients
    colors = [
      {"#000046", "#1CB5E0"},
      {"#007991", "#78ffd6"},
