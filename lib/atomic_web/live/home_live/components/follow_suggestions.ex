defmodule AtomicWeb.HomeLive.Components.FollowSuggestions do
  ...
  def follow_suggestions(assigns) do
    ...
    <div class="overflow-hidden">
      ...
      <div class="my-4">
        <.link patch={Routes.organization_index_path(AtomicWeb.Endpoint, :index)} class="text-primary flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium shadow-sm hover:bg-gray-50">
          View all
        </.link>
      </div>
    </div>
